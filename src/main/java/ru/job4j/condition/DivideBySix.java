...
public class DivideBySix {
    ...
    /*Version, with nested if - else. This code cannot be used!
    Версия, с вложенными if - else. Такой код использовать нельзя! */
    public static String checkNumberIfIfElseElseVersion(int number) {
        String rsl;
        if (number % 3 == 0) {
            if (number % 2 == 0) {
                rsl = "Исходное число делится на 6.";
